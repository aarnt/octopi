...
/*
 * Whenever user selects View/All we show him all the ignored packages
 */
 ...
 */
void MainWindow::selectedIgnoredPackagesMenu()
{
  m_selectedViewOption = ectn_IGNORED_PKGS;
  changePackageListModel(ectn_IGNORED_PKGS, m_selectedRepository);
}
