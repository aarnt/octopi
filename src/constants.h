...
const QString ctn_APPLICATION_VERSION(QStringLiteral("0.17.1 (dev)"));
...
const QString ctn_KEY_ALWAYS_USE_THE_TERMINAL(QStringLiteral("Always_Use_The_Terminal"));
...
const QString ctn_KEY_AUR_EDITMENU_PARAM(QStringLiteral("Aur_EditMenu_Param"));
