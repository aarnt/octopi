...
QString Package::removeColorCodesFromStr(const QString &str)
{
  ...
  ret = ret.remove(QStringLiteral("[92m"));
  ret = ret.remove(QStringLiteral("[94m"));
  ret = ret.remove(QStringLiteral("[95m"));
  ret = ret.remove(QStringLiteral("[96m"));
...
QList<PackageListData> * Package::getForeignToolPackageList(const QString &searchString)
{
  ...
  if (!auxSearchString.isEmpty() && auxSearchString.at(0) == QLatin1Char('-'))
